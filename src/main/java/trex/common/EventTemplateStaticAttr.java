...
public class EventTemplateStaticAttr {
	...
	public EventTemplateStaticAttr(String name, Geometry value) {
		this.attr = new Attribute(name, value);
	}
	...
	EventTemplateStaticAttr dup() {
		return new EventTemplateStaticAttr(attr);
	}

	@Override
	public String toString(){
		return this.getAttr().toString();
	}
